    ...
    <div class="w-4/12 bg-white p-6 rounded-lg">
        ...
        <form action="{{ route('login') }}" method="post">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="role" id="role" placeholder="Votre rôle" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('role') border-red-500 @enderror" value="{{ old('role') }}">
