            ...
            <div class="w-6/12 bg-white p-6 rounded-lg">
                <form action="{{ route('entreprise.updateCompany') }}" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="phone" id="phone" placeholder="Votre numéro de téléphone" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('phone') border-red-500 @enderror" value="{{ $company->phone }}">
