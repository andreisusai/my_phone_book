...
<div class="flex justify-center mt-6">
    <div class="pt-2 relative mx-auto text-gray-600">
        <input class="border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none" type="text" name="search" id="search" placeholder="Search">
        ...
        function fetch_company_data(val = '') {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#company_table').html(data.table_data);
